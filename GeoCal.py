...
def intrinsic(img, CALIB_DAY, cam_id):
    dir1 = f"/calibration/calibration params/geometric_params"
    dir = os.path.abspath(os.path.dirname(__file__) +dir1)
...
def main():
    ...
    # example image:
    # 
    image_to_load = r'\Data_From_Experiment\B\B11_20000\1\24_14_09_56_212847_101936.png'
