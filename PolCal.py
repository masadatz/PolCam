...
def load_xmat(cam_id):
    PolCal_dir = f"/calibration/calibration params/polcal_params/"
    PolCal_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), PolCal_dir))
...
def main3():
    ...
    image_dir =r'\calibration\101936_2\full_scan\CalMatrix_2000cnts_1500ET_POL0_CAM101936.npy'
